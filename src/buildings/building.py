...
class Building:
    ...
    def render(
        ...
        self._render_accent(surface, camera, size)
        self._render_ports(surface, camera, size)

    def _render_accent(self, surface: pygame.Surface, camera: Camera, size: int) -> None:
        w, h = self.footprint
        ox, oy = self.origin
